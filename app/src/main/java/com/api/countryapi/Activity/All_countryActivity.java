package com.api.countryapi.Activity;
...
import com.api.countryapi.Adapter.Adapter;
...
//        Adding String data
        ...
        try {
            currencies_name.setText(datalist.get(flags).getCurrencies().getUyu().getName());
            currencies_symbol.setText(datalist.get(flags).getCurrencies().getUyu().getSymbol());
        } catch (Exception e) {
        }
        ...
        try {
            ...
            languages.setText(datalist.get(flags).getLanguages().getSpa());
        } catch (Exception e) {
        ...
        try {
            population.setText(datalist.get(flags).getPopulation().toString());
        }catch (Exception e){
        }
        ...
        try {
            for (int i = 0; i < 5; i++) {
                ...
                capitalInfo1.setText(datalist.get(flags).getCapitalInfo().getLatlng().get(i).toString());
                capitalInfo2.setText(","+datalist.get(flags).getCapitalInfo().getLatlng().get(i).toString());
            }
        }catch (Exception e){
